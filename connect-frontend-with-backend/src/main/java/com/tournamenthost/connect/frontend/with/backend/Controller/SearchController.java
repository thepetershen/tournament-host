...
public class SearchController {
    ...
    public ResponseEntity<Map<String, Object>> unifiedSearch(@RequestParam("query") String query) {
        ...
        List<User> users = userRepository.findByUsernameOrNameContainingIgnoreCaseAndSpaces(query);
        ...
        List<Tournament> tournaments = tournamentRepository.findByNameContainingIgnoreCaseAndSpaces(query);
